...
Code written by: Adam Porter
https://github.com/aporter/coursera-android/blob/master/Examples/SensorCompass/src/course/examples/compass/CompassActivity.java
...
public class Compass extends Activity implements SensorEventListener {
	...
	public class CompassArrowView extends View {
		...
		Bitmap mBitmap = BitmapFactory.decodeResource(getResources(),
				R.drawable.arrow);
		Bitmap resize = Bitmap.createScaledBitmap(mBitmap, 400, 400, false);
		int mBitmapWidth = resize.getWidth();
		...
		protected void onDraw(Canvas canvas) {
			...
			// Redraw this View
			canvas.drawBitmap(resize, mViewLeftY, mViewTopX, null);
